...
describe("index", () => {
  ...
  describe("arrangeExpression", () => {
    it("should push sort variables by algorithmic priority from left to right", () => {
      ...
      expect(arrangeExpression("((X - 3) * 2) = 2")).toEqual([
        2,
        "*",
        "(X - 3)",
        2,
    ...
    it("Should handle large expression", () => {
      ...
      const expected = [
        -660,
        '+',
        `(21 * (299 + (((((((((367 + ((2 * (((((224 + ((((((323 + (((6 * (((((560 + ((((116 + ((((((((((((((449 + (X - 165)) / 2) + 1) * 68) - 489) * 2) + 729) / 5) - 892) * 2) + 687) / 5) - 506) * 2)) / 2) - 71) / 2)) * 10) - 397) / 9) + 782)) - 249) / 3)) * 3) + 170) / 2) - 438) * 3)) / 4) - 160) * 4) + 249)) - 873)) / 12) + 667) + 490) / 3) - 983) * 5) - 900) / 5)))`,
        10000,
      ];
